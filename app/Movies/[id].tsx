...
const MovieDetails = () => {
  ...
  return (
    <View  className='bg-primary flex-1'>
      ...
      <TouchableOpacity className='absolute bottom-5 right-0 left-0 mx-5 my-2 bg-accent rounded-lg py-4 flex-row items-center justify-center z-50' onPress={router.back}>
